...
@section('content')
    ...
    @push('head')
        ...
        <link rel="stylesheet" href="{{ asset('theme/plugins/chartist/dist/chartist.min.css') }}">
    @endpush
    ...
    <div class="container-fluid">
    	<div class="row">
            ...
            <div class="col-xl-4 col-md-6">
              @include('pages.modules.newusers')
            </div>
            <div class="col-xl-8 col-md-6">
              @include('pages.modules.links')
            </div>
	...
	<!-- push external js -->
    @push('script')
        <script src="{{ asset('theme/plugins/owl.carousel/dist/owl.carousel.min.js') }}"></script>
        <script src="{{ asset('theme/plugins/chartist/dist/chartist.min.js') }}"></script>
        <script src="{{ asset('theme/plugins/flot-charts/jquery.flot.js') }}"></script>
        <!-- <script src="{{ asset('plugins/flot-charts/jquery.flot.categories.js') }}"></script> -->
        <script src="{{ asset('theme/plugins/flot-charts/curvedLines.js') }}"></script>
        <script src="{{ asset('theme/plugins/flot-charts/jquery.flot.tooltip.min.js') }}"></script>

        <script src="{{ asset('theme/plugins/amcharts/amcharts.js') }}"></script>
        <script src="{{ asset('theme/plugins/amcharts/serial.js') }}"></script>
        <script src="{{ asset('theme/plugins/amcharts/themes/light.js') }}"></script>


        <script src="{{ asset('theme/js/widget-statistic.js') }}"></script>
        <script src="{{ asset('theme/js/widget-data.js') }}"></script>
        <script src="{{ asset('theme/js/dashboard-charts.js') }}"></script>
